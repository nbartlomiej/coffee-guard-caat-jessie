...
* Jessie allows to run Jasmine specs in console (https://github.com/futuresimple/jessie) and Jasmine is a nice BDD framework for JavaScript (https://jasmine.github.io/).
